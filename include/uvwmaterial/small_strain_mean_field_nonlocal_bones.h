...
****************************************************************************/
#ifndef SMALL_STRAIN_MEAN_FIELD_NONLOCAL_BONES_H
#define SMALL_STRAIN_MEAN_FIELD_NONLOCAL_BONES_H

template<typename _T, std::size_t _Dim, typename _Container>
class small_strain_mean_field_composite_damage_nonlocal :
        public small_strain_mean_field_composite<_T, _Dim, _Container>,
        public composite_history_base<_T, _Dim, _Container>,
        public composite_nonlocal_material_base<_T, _Dim, _Container>
{
public:
    using value_type = _T;
    using size_type  = std::size_t;

    constexpr small_strain_mean_field_composite_damage_nonlocal():
        small_strain_mean_field_composite<_T, _Dim, _Container>(),
        composite_history_base<_T, _Dim, _Container>(this),
        composite_nonlocal_material_base<_T, _Dim, _Container>(this)
    {}

    virtual ~small_strain_mean_field_composite_damage_nonlocal(){}

    inline virtual void init()override{
        small_strain_mean_field_composite<_T, _Dim, _Container>::init();
        composite_history_base<_T, _Dim, _Container>::init();
        composite_nonlocal_material_base<_T, _Dim, _Container>::init();
    }
    ...
    inline virtual void update()override{
        ...
        composite_nonlocal_material_base<_T, _Dim, _Container>::update();
...
#endif // SMALL_STRAIN_MEAN_FIELD_NONLOCAL_BONES_H
